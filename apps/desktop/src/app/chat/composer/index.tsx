...
export function ChatBar({
  ...
  const COMPOSITION_TIMEOUT_MS = 500  // safety reset if compositionend never fires (CRD/Android bursty input)
    ...
    <div className={cn('relative', stacked ? 'w-full' : 'min-w-(--composer-input-inline-min-width) flex-1')}>
      <div
        ...
        onCompositionStart={() => {
          ...
          // Safety: CRD/Android bursty input can fire compositionstart without
          // ever delivering compositionend, permanently swallowing all input.
          if (compositionTimerRef.current) {
            clearTimeout(compositionTimerRef.current)
          }
